variable "f5_ui" { default = "" }

variable "f5_username" { default = "" }

variable "f5_password" { default = "" }

variable "as3tenant" { default = "dev" }

variable "as3app" { default = "sharedVip" }

variable "as3vip" { default = "10.0.2.102" }
